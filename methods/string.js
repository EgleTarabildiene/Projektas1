...
const sakinys22 = `"${text}" turi ${text.length} raides.`;
console.log(sakinys22);
...
const pavarde2 = `Pavardes "${surname2}" ilgis yra ${surname1.length} simboliai.`;
console.log(pavarde2);

const pavarde3 = `Pavardes "${surname3}" ilgis yra ${surname1.length} simboliai.`;
console.log(pavarde3);

const pavarde4 = `Pavardes "${surname4}" ilgis yra ${surname1.length} simboliai.`;
